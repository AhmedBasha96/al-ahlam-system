        ...
        {error && (
          <div className="mb-4 p-3 bg-red-100 border-l-4 border-red-500 text-red-700 text-sm">
            ...
            <div className="mt-2 text-[10px] text-gray-500 border-t pt-1">
              {process.env.DATABASE_URL?.includes('undefined') && <span>⚠️ DATABASE_URL contains 'undefined' string. </span>}
              {!process.env.TURSO_AUTH_TOKEN && <span>⚠️ Auth Token is missing. </span>}
            </div>
          </div>
        )}
