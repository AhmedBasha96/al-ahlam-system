...
export default async function DashboardLayout({
    ...
    const canSeeLoadingRequests = role === 'ADMIN' || role === 'MANAGER' || role === 'WAREHOUSE_KEEPER' || role === 'SALES_REPRESENTATIVE';
        ...
        <div className="flex min-h-screen bg-gray-50 flex-col md:flex-row">
            ...
            <aside className="w-full md:w-64 bg-emerald-800 text-white flex-shrink-0">
                ...
                <nav className="p-4 space-y-2">
                    ...
                    {/* Loading Requests */}
                    {canSeeLoadingRequests && (
                        <Link href="/dashboard/loading-requests" className="flex items-center gap-3 px-4 py-3 hover:bg-emerald-700 rounded-lg transition">
                            <svg className="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    {/* Record Sales - Specialized Role */}
                    {canRecordSales && (
                        <Link href="/dashboard/record-sales" className="flex items-center gap-3 px-4 py-3 hover:bg-emerald-700 bg-emerald-900/40 rounded-lg transition text-yellow-100 border border-yellow-500/30">
                            <svg className="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
                            </svg>
                            <span className="font-bold">تسجيل الفواتير ✅</span>
                        </Link>
                    )}
